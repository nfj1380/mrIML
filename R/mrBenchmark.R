...
#'
#' @param dat A \code{character} object name of data frame 
...
mrBenchmark <- function(dat = "data", outcome = "class", y = "predicted", group = "group1", label_by = "ID", type = "internal"){
  
  #create objects from character strings
  data1 <- as.data.frame(eval(parse(text=dat)))
