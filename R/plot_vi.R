...
#'@param X A \code{dataframe} feature data 
#'@param Y A \code{dataframe} response data 
#'@param modelPerf A \code{dataframe} data frame generated by modelPerf function
#'@param cutoff A \code{numeric} determines  Mathews correlation coefficient (mcc) threshold for displaying individual response model. Default is 0.5
...
plot_vi <- function (VI, modelPerf, Y, X, groupCov=NULL, cutoff= 0.2, mode='regression' ){
