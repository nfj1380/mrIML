...
---
![](C:/Users/gmachad/Desktop/mrIML_package/Logo_mrIML.png){width=25%}
...
fl <- mrFlashlight(yhats, X, Y, response = "single", index=1, model='classification') #index pointing to the SNP of interest (i.e. the first column)
