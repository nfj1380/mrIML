...
library(mrIML)
library(parsnip); library(tidymodels); library(workflows); library(tidyverse); library(flashlight); library(devtools); library(DALEX); library(plyr);library(vip); library(ggsci); library(ggrepel); library(breakDown); library(future.apply); library(janitor)
...
This session of the MrIML has been funded by Critical Agricultural Research and Extension 2019-68008-29910 from the USDA National Institute of Food and Agriculture and is a join effort by [Dr. Linhares group](https://fieldepi.research.cvm.iastate.edu/) at Iowa State University and [Dr. Machado group](https://machado-lab.github.io/) at North Carolina State University 
