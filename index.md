...
[**mrIML**](https://travis-ci.org/github//mrIML/branches).
However, that only checks for Linux and **mrIML** is built on Windows.

## <i class="fas fa-star"></i> Quick start
...
## <i class="fas fa-cog"></i> Model component
